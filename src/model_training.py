...
class ModelTrainer:
    ...
    def _encode_brand_by_price(self):
        """
        Target encoding brenda: svaki brend se zamenjuje PROSEČNOM cenom
        automobila tog brenda. Time brend nosi direktan signal o ceni i ima
        znatno jači uticaj na predikciju (i kod stabala i kod linearnih modela).
        Prosek se računa SAMO na train setu kako bi se izbeglo curenje podataka.
        """
